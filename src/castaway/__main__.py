...
class node(object):
	...
	def _string(self, num, amount):
		for i in self.mats:
			...
			if type(i.name) == str:
				...
				ret = '\n{}{}{}'.format('\t'*num, i.name, self._amount(i.amount*amount, '[]'))
			else:
	...
	def string(self, num, amount=1):
		...
		ret = '{}{}{}{}{}'.format('\t'*num, self.name, self._amount(self.amount, '{}'), self._amount(amount, '[]'), ''.join(self._string(num+1, a)))
...
dic = {
	...
	'Titan Scimitar': node('Titan Scimitar', 1, [mat('Scimitar', 1), mat('Sapphire Globe', 1)]),
	'Dartanian Sword': node('Dartanian Sword', 1, [mat('Piercer', 1), mat('Emerald Globe', 1)]),
	'Scholar': node('Scholar', 1, [mat("Sorcerer's Sapphire", 1), mat('Regal Sword', 1)]),
	'Nail Bat': node('Nail Bat', 1, [mat('Iron Ignot', 1), mat('Timber Wood', 1)]),
	'Vindicator Club': node('Vindicator Club', 1, [mat('Nail Bat', 1), mat('Iron Globe', 1)]),
	'Apprentice Wand': node('Apprentice Wand', 1, [mat('Stick', 1), mat('Sapphire Shard', 1)]),
	'Imp Branche': node('Imp Branche', 1, [mat('Apprentice Wand', 1), mat('Gaea Seed', 1)]),
	'Trusty Dagger': node('Trusty Dagger', 1, [mat('Rusty Dagger', 1), mat('Alkahest', 1)]),
	'Assassin Dagger': node('Assassin Dagger', 1, [mat('Trusty Dagger', 1), mat('Ruby Shard', 1)]),
	'Staff of the Magi': node('Staff of the Magi', 1, [mat('Seal of Magi', 1), mat("Wizard's Rod", 1)]),
	'Widow Claw': node('Widow Claw', 1, [mat('Fachata', 1), mat('Ruby Globe', 1)]),
	'Razor Sword': node('Razor Sword', 1, [mat('Wooden Sword', 1), mat('Iron Globe', 5)]),
	"Paladin's Mace": node("Paladin's Mace", 1, [mat('Peace Batton', 1), mat("Angel's Tear", 1)]),
	'Morning Star': node('Morning Star', 1, [mat("Paladin's Mace", 1), mat('Vindicator', 1)]),
	'Deadwood Staff': node('Deadwood Staff', 1, [mat('Imp Staff', 1), mat("Necromancer's Heart", 1)]),
	...
	'Gold Ninja Stars': node('Gold Ninja Stars', 5, [mat('Gold Ore', 1), mat('Alkahest', 1)]),
	'Ninja Stars': node('Ninja Stars', 5, [mat('Iron Ore', 1), mat('Alkahest', 1)]),
	'Emerald Dart': node('Emerald Dart', 5, [mat('Emerald Shard', 1), mat('Alkahest', 1)]),
	'Sapphire Dart': node('Sapphire Dart', 5, [mat('Sapphire Shard', 1), mat('Alkahest', 1)]),
	'Ruby Dart': node('Ruby Dart', 5, [mat('Ruby Shard', 1), mat('Alkahest', 1)]),
	'Shuriken': node('Shuriken', 1, [mat('Iron', 1), mat('Alkahest', 1)]),
	'Beetle Shield': node('Beetle Shield', 1, [mat('Animal Hide', 3), mat('Animal Shell', 3)]),
	'Round Shield': node('Round Shield', 1, [mat('Wooden Shield', 1), mat('Iron Ignot', 1)]),
	"Warrior's Shield": node("Warrior's Shield", 1, [mat("Knight's Memento", 1), mat('Round Shield', 1)]),
	'Plate Chest Armor': node('Plate Chest Armor', 1, [mat('Plate', 1), mat('Leather Chest Armor', 1)]),
	'Plate Helmet': node('Plate Helmet', 1, [mat('Leather Helmet', 1), mat('Plate', 1)]),
	'Blast Shield': node('Blast Shield', 1, [mat('Iron Globe', 1), mat("Warrior's Shield", 1)]),
	'Golem Armor': node('Golem Armor', 1, [mat('Leather Armor', 1), mat('Golem Talisman', 1)]),
	'Minotaur Armor': node('Minotaur Armor', 1, [mat('Golem Armor', 1), mat('Minotaur Talisman', 1)]),
	'Paladin Armor': node('Paladin Armor', 1, [mat('Old Guard Armor', 1), mat('Knight Talisman (Mage)', 1)]),
	'Saint Armor': node('Saint Armor', 1, [mat('Paladin Armor', 1), mat('Saint Talisman (Mage)', 1)]),
	"Beetle God's Shield": node("Beetle God's Shield", 1, [mat('Blast Shield', 1), mat('Beetle God Icon', 1)]),
	'Plate Armor': node('Plate Armor', 1, [mat('Leather Armor', 1), mat('Plate', 1)]),
	'Plate Sleeves': node('Plate Sleeves', 1, [mat('Leather Sleeves', 1), mat('Plate', 1)]),
	'Plate Leggings': node('Plate Leggings', 1, [mat('Leather Leggings', 1), mat('Plate', 1)]),
	'Minotaur Chest Armor': node('Minotaur Chest Armor', 1, [mat('Golem Armor', 1), mat('Minotaur Talisman', 1)]),
	...
	'Treated Leather': node('Treated Leather', 1, [mat('Leather', 3), mat('Alkahest', 1)]),
	'Alkahest': node('Alkahest', 1, [mat('Antidote', 1), mat('Small Healing Potion', 1)]),
	'Emerald': node('Emerald', 1, [mat('Emerald Shard', 3), mat('Emerald Shard', 3)]),
	'Sapphire': node('Sapphire', 1, [mat('Sapphire Shard', 3), mat('Sapphire Shard', 3)]),
	'Ruby': node('Ruby', 1, [mat('Ruby Shard', 3), mat('Ruby Shard', 3)]),
	'Emerald Globe': node('Emerald Globe', 1, [mat('Emerald', 3), mat('Alkahest', 1)]),
	'Sapphire Globe': node('Sapphire Globe', 1, [mat('Sapphire', 3), mat('Alkahest', 1)]),
	...
	'Small Healing Potion': node('Small Healing Potion', 1, [mat('Healing Herb', 3), mat('Empty Bottle', 1)]),
	'Medium Healing Potion': node('Medium Healing Potion', 1, [mat('Healing Herb', 6), mat('Empty Bottle', 1)]),
	'Large Healing Potion': node('Large Healing Potion', 1, [mat('Healing Herb', 12), mat('Empty Bottle', 1)]),
	'Small Mana Potion': node('Small Mana Potion', 1, [mat('Mana Herb', 3), mat('Empty Bottle', 1)]),
	'Medium Mana Potion': node('Medium Mana Potion', 1, [mat('Mana Herb', 6), mat('Empty Bottle', 1)]),
	'Large Mana Potion': node('Large Mana Potion', 1, [mat('Mana Herb', 12), mat('Empty Bottle', 1)]),
	'Small Berry Potion': node('Small Berry Potion', 1, [mat('Teras Berrie', 3), mat('Empty Bottle', 1)]),
	'Medium Berry Potion': node('Medium Berry Potion', 1, [mat('Teras Berrie', 6), mat('Empty Bottle', 1)]),
	'Large Berry Potion': node('Large Berry Potion', 1, [mat('Teras Berrie', 12), mat('Empty Bottle', 1)]),
	'Ambrosia': node('Ambrosia', 1, [mat('Large Health Potion', 1), mat('Large Mana Potion', 1)]),
